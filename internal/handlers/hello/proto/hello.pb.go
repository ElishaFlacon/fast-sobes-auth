...
const file_proto_hello_proto_rawDesc = "" +
	"\n" +
	"\x11proto/hello.proto\x12\x05hello\x1a\x1bgoogle/protobuf/empty.proto\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2>\n" +
	"\x05Hello\x125\n" +
	"\x05Hello\x12\x16.google.protobuf.Empty\x1a\x14.hello.HelloResponseB%Z#internal/handlers/hello/proto;protob\x06proto3"
...
var file_proto_hello_proto_depIdxs = []int32{
	1, // 0: hello.Hello.Hello:input_type -> google.protobuf.Empty
	0, // 1: hello.Hello.Hello:output_type -> hello.HelloResponse
